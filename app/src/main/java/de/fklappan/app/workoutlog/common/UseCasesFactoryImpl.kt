...
class UseCasesFactoryImpl(val repository: WorkoutLogRepository) : UseCasesFactory {
    ...
    override fun createEditResultUseCase(): EditResultUseCase = EditResultUseCase(repository)
    ...
    override fun createDeleteResultUseCase(): DeleteResultUseCase = DeleteResultUseCase(repository)
}